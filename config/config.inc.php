...
$_DVWA[ 'db_server' ]   = 'mainline.proxy.rlwy.net';   // Host do banco Railway
$_DVWA[ 'db_database' ] = 'railway';                   // Nome do banco
$_DVWA[ 'db_user' ]     = 'root';                      // Usuário
$_DVWA[ 'db_password' ] = 'TePqwlJMaLiVVOpPyzIzJCOvlprruwWC';  // Senha
$_DVWA[ 'default_security_level' ] = 'low';            // Nível de segurança DVWA
$_DVWA[ 'db_port']      = getenv('DB_PORT') ?: '51622';
